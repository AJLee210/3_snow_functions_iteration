...
```{r, message=F}
#make monthly tempearature data frame
...
for(i in 2005:2010){
  ...
  print(ggplot(temp_monthly_by_year, aes(x=month, y=average_temp, color = site)) +
   geom_point() +
   geom_line() +
   ggthemes::theme_few() + 
   ggthemes::scale_color_few() +
...
for(i in 2005:2010){
  ...
  print(ggplot(precip_daily_by_year, aes(x=month, y=average_day_precip, color = site)) +
   geom_point() +
   geom_line() +
   ggthemes::theme_few() + 
   ggthemes::scale_color_few())
